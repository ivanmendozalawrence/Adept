...
const SearchIcon = () => (
  <svg width="20" height="20" fill="none"><circle cx="9" cy="9" r="7.5" stroke="#A2A9B0" strokeWidth="2"/><path d="M16 16L13.5 13.5" stroke="#A2A9B0" strokeWidth="2" strokeLinecap="round"/></svg>
);
...
const TableRow = ({ partnerName, status, statusText, lastUpdate }) => (
  <div className="table-row">
    <div className="table-cell partner-name">
      <span>{partnerName}</span>
    </div>
    <div className="table-cell status-cell">
      <StatusBadge status={status} text={statusText} />
    </div>
    <div className="table-cell last-update">
      ...
      <div className="alert-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-content">
          <div className="modal-icon">
            <LargeAlertTriangleIcon />
          </div>
          <div className="modal-header">
            <h2 className="modal-title">Health Status Alert</h2>
          </div>
          <div className="modal-body">
            <p className="modal-description">
              The following partner(s) has/have reached 'Inconsistent' health status:
            </p>
            <p className="modal-partner">
              • Global Payments Co.
            </p>
          </div>
...
const SignOutModal = ({ isOpen, onCancel, onSignOut }) => {
  if (!isOpen) return null;
    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="signout-modal" onClick={e => e.stopPropagation()}>
        ...
        <p className="signout-modal-desc">
          Sign out your account and you will be redirected to the landing page.
        </p>
...
export const DashboardOverview = () => {
  ...
  const [invitedPartnerName, setInvitedPartnerName] = React.useState("");

  const partners = [
    { partnerName: 'Secure Fintech Inc.', status: 'monitoring', statusText: 'Monitoring', lastUpdate: 'Yesterday' },
    { partnerName: 'Global Payments Co.', status: 'inconsistent', statusText: 'Inconsistent', lastUpdate: '1 hour ago' },
    { partnerName: 'Manila Microfinance', status: 'consistent', statusText: 'Consistent', lastUpdate: '3 days ago' },
    { partnerName: 'Metro Trade Logistics', status: 'pending', statusText: 'Pending Invite', lastUpdate: '1 min ago' }
  ];
  ...
  const handleProceedToOverview = () => {
    setShowModal(false);
    // Additional logic for proceeding to overview can be added here
  };
  ...
  const handleInviteSubmit = (e) => {
    ...
    // Placeholder check for non-empty fields
    if (companyNameInput.value.trim() && emailInput.value.trim()) {
      setInvitedPartnerName(companyNameInput.value);
  ...
  // Rendered alert card based on search
  let alertCard = null;
  if (normalizedSearch === "global payments co.") {
    alertCard = (
      <div className="insights-alert-card">
        <div className="insights-alert-title">High-Risk Collaboration Alerts</div>
        <div className="insights-alert-content">
          [AI Insight]<br />
          <span className="insights-alert-action">Recommend Action:</span><br />
          <a className="insights-alert-link" href="#">[AI Recommended Action]</a>
        </div>
      </div>
    );
  } else if (normalizedSearch === "manila microfinance") {
    alertCard = (
      <div className="insights-alert-card">
        <div className="insights-alert-title">Efficiency Opportunities</div>
        <div className="insights-alert-content success">
          [AI Insight]<br />
          <span className="insights-alert-action">Benefit/Action:</span><br />
          <a className="insights-alert-link" href="#">[AI Recommended Action]</a>
        </div>
      </div>
    );
  } else if (normalizedSearch === "secure fintech inc.") {
    alertCard = (
      <div className="insights-alert-card">
        <div className="insights-alert-title">Compliance Drift Watch</div>
        <div className="insights-alert-content warning">
          Observing potential deviation in <b>'[AI Insight]'</b> with <b>Secure Fintech Inc.</b>.<br />
          <span className="insights-alert-action">Recommend Action:</span><br />
          <a className="insights-alert-link" href="#">[AI Recommended Action]</a>
        </div>
      </div>
  ...
  return (
    <div className="dashboard-page">
      ...
      <aside className="dashboard-sidebar">
        <div className="sidebar-content">
          ...
          <nav className="sidebar-nav">
            ...
            <div className="nav-item" onClick={handleSignOutClick}>
              <LogOutIcon />
              <span>Sign out</span>
            </div>
          </nav>
      ...
      <main className="dashboard-main">
        <div className="main-content">
          ...
          {activeTab === "overview" && (
            <div className="dashboard-section">
              <div className="section-header">
                <h2 className="section-title">Partner Collaboration Health</h2>
                <p className="section-subtitle">Overview for BPI</p>
              </div>
              ...
              <div className="data-table">
                ...
                <div className="table-header">
                  <div className="table-header-cell partner-name-header">
                    <span>Partner Name</span>
                    <SortIcon />
                  </div>
                  <div className="table-header-cell status-header">
                    <span>Health Status</span>
                    <DownArrowIcon />
                  </div>
                  <div className="table-header-cell last-update-header">
              ...
              <div className="pagination">
                <div className="pagination-item disabled">
                  <ChevronLeftIcon />
                  <span>Previous</span>
                </div>
          ...
          {activeTab === "insights" && (
            <div className="dashboard-section">
              <div className="section-header">
                <h2 className="section-title">Predictive Collaboration Insights</h2>
                <p className="section-subtitle">Key AI-Driven Alerts & Opportunities for BPI</p>
              </div>
              <div className="section-divider"></div>
                    ...
                    <>
                      ...
                      <div className="insights-card">
                        ...
                        <svg width="480" height="180" viewBox="0 0 480 180">
                          {[
                            135, 105, 90, 120, 90, 75, 60, 90, 120, 135, 105, 120
                          ].map((height, i) => (
                            <rect
                              key={i}
                              x={24 + i * 36}
                          ...
                          <line x1="24" y1="168" x2="456" y2="168" stroke="#A2A9B0" strokeWidth="2"/>
                        ...
                        <div className="insights-bar-chart-label">
                          Improving Collaboration Health
                        </div>
                      </div>
                      
                      {/* Partner Health Status Card */}
                      <div className="insights-card">
                        <div className="insights-card-header">
                        ...
                        <div className="insights-gauges-row">
                          ...
                          <div className="insights-gauge">
                            <svg width="140" height="90" viewBox="0 0 140 90">
                              <path
                                d="M20,75 A50,50 0 1,1 120,75"
                                stroke="#1564E0"
                                strokeWidth="12"
                                fill="none"
                              />
                              <path
                                d="M20,75 A50,50 0 0,1 70,20"
                                stroke="#1564E0"
                                strokeOpacity="0.2"
                                strokeWidth="12"
                                fill="none"
                            ...
                            <div className="insights-gauge-value">33%</div>
                            <div className="insights-gauge-label">Consistent</div>
                          </div>
                          {/* Monitoring */}
                          <div className="insights-gauge">
                            <svg width="140" height="90" viewBox="0 0 140 90">
                            ...
                            <div className="insights-gauge-value">33%</div>
                            <div className="insights-gauge-label">Monitoring</div>
                          </div>
                          {/* Inconsistent */}
                          <div className="insights-gauge">
                            <svg width="140" height="90" viewBox="0 0 140 90">
                            ...
                            <div className="insights-gauge-value">33%</div>
                            <div className="insights-gauge-label">Inconsistent</div>
                          </div>
                        </div>
                      </div>
                    </>
              ...
              <div className="invite-card">
                {invitationSent ? (
                  <div className="invite-success-message">
                    <CheckIcon />
                    <div className="invite-success-text-container">
                      <p className="invite-success-main">
                        Invitation successfully sent to <strong>{invitedPartnerName}</strong>.
                      </p>
                      <p className="invite-success-sub">
                        Proceed to Overview for health status update.
                      </p>
                    </div>
                  </div>
                ) : (
                  <>
                    ...
                    <form className="invite-form" onSubmit={handleInviteSubmit}>
                      <div className="form-group">
                        <label htmlFor="companyName" className="form-label">Partner Company Name</label>
                        <input type="text" id="companyName" className="form-input" placeholder="e.g., Bank of the Philippine Islands" />
                      </div>
                      <div className="form-group">
                        <label htmlFor="contactEmail" className="form-label">Partner Contact Email</label>
                        <input type="email" id="contactEmail" className="form-input" placeholder="onboarding@bpi.com.ph" />
                      </div>
      ...
      <AlertModal
        ...
        onProceed={handleProceedToOverview}
      />
      {/* Sign Out Modal */}
      <SignOutModal

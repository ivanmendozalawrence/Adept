import loginLeftImg from "./login-left-column.png";
import "./style.css";
    ...
    <div className="login-page">
      ...
      <div className="login-left-column">
        <div className="login-image-container">
          <img src={loginLeftImg} alt="Login background" className="login-bg-image" />
        </div>
      </div>
      ...
      <div className="login-right-column">
        <div className="login-content">
          ...
          <div className="login-description">
            <p>
              To access ADEPT, please make sure to use your office email account.
              <br /><br />
              For this prototype, Google Workspace Personal Account will be used for demonstration.
            </p>
          </div>
          ...
          <div className="login-footer">
            <a href="#" className="footer-link">Need help signing in? Learn More</a>
